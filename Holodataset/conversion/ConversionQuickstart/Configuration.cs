...
namespace ConversionQuickstart
{
    public class Configuration
    {
        ...
        public string AccountId = "2f6b87f0-c8e9-41fb-9cf3-2c128d8ee00e";

        // Azure Object Anchors account primary key
        public string AccountKey = "d7RVRNWVViOvdDqHtTSTXey/KFTbb24us7P2TAY3SrU=";

        // Azure Object Anchors account domain
        public string AccountDomain = "northeurope.mixedreality.azure.com";

        // Path to 3D asset file on your local machine
        public string InputAssetPath = "C:/Users/11424/Documents/3dmodel/3D_model";
        ...
        public Vector3 Gravity = new Vector3(0.0f, 0.0f, -1.0f);
